...
function Maincover() {
  return (
    <div class="parallax">
      <div class="container col-12 d-flex justify-content-center align-items-center parallax-content" style={{ height: "100vh", position:"absolute"}}>
